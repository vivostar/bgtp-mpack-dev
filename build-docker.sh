...
docker cp ./resources/mysql-connector-java-5.1.47.jar ambari-server:/usr/share/java/mysql-connector-java.jar
...
docker cp ./resources/krb5.conf ambari-server:/etc/krb5.conf
docker cp ./resources/krb5.conf ambari-agent-01:/etc/krb5.conf
docker cp ./resources/krb5.conf ambari-agent-02:/etc/krb5.conf
